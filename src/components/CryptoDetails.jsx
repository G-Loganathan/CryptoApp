  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        ...
        <p>
          {cryptoDetails?.name} live price in US dollars. View value satsistics,
      ...
      <Col className="coin-desc-link">
            <Row className="coin-desc">
              <Title level={3} className="coin-details-heading">
                ...
                <p>{cryptoDetails?.description ? HTMLReactParser(cryptoDetails.description) : "Description is unavailable."}</p>
              </Title>
            </Row>
